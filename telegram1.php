...
$API_KEY = '7708515774:AAFNJ0_ylvLxmiDQsiUTC5ZNzbgodx3IbW8'; #توكن بوتك عزيزي
...
$useradmin = "IDIIS"; #يوزرك بدون علامة البطة @ 
$userbots = "JBA01BOT"; #يوزر بوتك بدون علامة البطة @
...
$ex_list = explode("\n", $file_list);
$admins = array(0000000, 00000); #ايديهات الادمنية
$bot_id = 6666666666; #ايدي بوتك
...
bot('answerInlineQuery',[
        ...
        'results' => json_encode([[
            ...
            'reply_markup'=>['inline_keyboard'=>[
                [
                ['text'=>'للدخول الى البوت اضغط هنا ♻️','url'=>'https://telegram.me/$userbots']
                ],
             ]]
        ]])
    ]);
...
if($text == "ايدي" && !$message->reply_to_message){
bot('sendMessage',[
'chat_id'=>$chat_id,
...
'inline_keyboard'=>[
        [
          ['text'=>'تابع قناتنا', 'url'=>"https://telegram.me/izeoe"]
        ],
        [
        ['text'=>'المطور', 'url'=>"https://telegram.me/MAHDI_VE1"]
        ],
]
])
]);
...
[
['text'=>'اضفني الى مجموعتك 🚹➕', 'url'=>"https://telegram.me/$userbots?startgroup="]
],
[
['text'=>'شارك البوت 🤖🍁', 'switch_inline_query'=>""]
],
[
['text'=>"هل لديك سؤال ❔ ","url"=>"https://telegram.me/$useradmin"]
]
]
])
]);
...
[
['text'=>'اضفني الى مجموعتك 🚹➕', 'url'=>"https://telegram.me/$userbots?startgroup=start"]
],
[
...
[
['text'=>"اصدر البوت بتاريخ 📅 2024/10/23 ☘", "callback_data"=>"omar"]
]
]
])
]);
